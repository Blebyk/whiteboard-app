...
### 🤝 Совместная работа
- **Поделиться доской** по email — кнопка в верхней панели (только для владельца)
- Перед отправкой приглашения выбирается роль: **Редактор** или **Зритель**
...
### Шаринг
- `POST /api/boards/[id]/share` — выдать доступ по email с ролью (только владелец)
